...
class LanguageMap {
  static final Map message = {
    "vi": {
      ...
      "code.copyID": "ID công dân",
      "code.copied": "Đã sao chép!",
      "code.idDesc": "ID là mã cá nhân duy nhất, gửi lại cho đơn vị quản lý để phục vụ công tác quản lý.",
    ...
    "en": {
      ...
      "code.copyID": "Personal ID",
      "code.copied": "Copied to clipboard!",
      "code.idDesc": "ID is a unique personal code, sent back to the management unit for management purposes.",
